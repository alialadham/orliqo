  ...
  return (
    <div className="min-h-dvh overflow-x-hidden bg-background lg:pl-[228px]">
      ...
      <div className="min-h-dvh">
        ...
        <main className="min-h-[calc(100dvh-104px)] min-w-0 overflow-x-hidden px-4 pt-6 pb-28 sm:px-5 lg:min-h-[calc(100dvh-104px)] lg:px-7 lg:pt-6 lg:pb-8">{children}</main>
