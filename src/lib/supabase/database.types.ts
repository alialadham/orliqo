...
type BusinessProfileRow = {
  ...
  main_customer_problem: string | null;
  competitive_advantage: string | null;
  default_cta: string | null;
  custom_cta: string | null;
  brand_tone: string | null;
  target_industry_summary: string | null;
  selling_points: Json;
  channel_preferences: Json;
  campaign_defaults: Json;
  onboarding_completed: boolean;
  onboarding_step: number;
  imported_from_website_at: string | null;
  created_at: string;
  updated_at: string;
};
...
type IcpRow = {
  ...
  business_age_min: number | null;
  business_age_max: number | null;
  website_statuses: string[];
  social_activity_min: number | null;
  review_count_min: number | null;
  keywords: string[];
  ...
  active: boolean;
  is_default: boolean;
  audience_breadth: "narrow" | "balanced" | "broad";
...
type LeadRow = {
  ...
  website_status_confidence: string;
  email: string | null;
  ...
  normalized_business_city: string | null;
  normalized_instagram_url: string | null;
  ...
  business_city_fingerprint: string | null;
  instagram_fingerprint: string | null;
  facebook_fingerprint: string | null;
  linkedin_fingerprint: string | null;
  created_at: string;
  updated_at: string;
};
...
export type Database = {
  public: {
    Tables: {
      ...
      daily_analytics: TableDefinition<{
        id: string;
        workspace_id: string;
      ...
      lead_sources: TableDefinition<{
        ...
        retrieved_at: string;
        confidence: string;
        allowed_for_automated_use: boolean;
        citation_text: string | null;
        content_hash: string;
        created_at: string;
        updated_at: string;
      ...
      provider_sync_states: TableDefinition<{
        id: string;
        workspace_id: string;
      ...
      whatsapp_templates: TableDefinition<{
        id: string;
        workspace_id: string;
        integration_id: string;
      ...
      email_accounts: TableDefinition<{
        id: string;
        workspace_id: string;
        integration_id: string;
      ...
      scheduled_events: TableDefinition<{
        id: string;
        workspace_id: string;
        campaign_id: string | null;
        lead_id: string | null;
    ...
    Functions: {
      suppress_lead: {
        Args: {
          ...
          suppression_origin?: string;
        };
        Returns: boolean;
      };
      restore_suppressed_lead: {
